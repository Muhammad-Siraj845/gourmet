...
import { FaFacebook, FaTwitter, FaInstagram, FaYoutube, FaEnvelope, FaPhone, FaMapMarkerAlt, FaClock, FaUtensils, FaGlassMartiniAlt, FaConciergeBell, FaYelp } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Experience the finest dining in town with our exceptional cuisine and warm atmosphere.
            </p>
          </div>
